                ...
                <div class="card pub_image pub_image_detail">
                    ...
                    <div class="card-body">
                        ...
                        @if(Auth::user() && Auth::user()->id == $image->user->id)
                            <div class="actions">
                                <a href="{{ route('image.edit', ['id' => $image->id]) }}" class="btn btn-primary ml-2">Actualizar</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Si eliminas esta imagen nunca podras recuperarla, estas seguro de quere borrarla?
                                            </div>
